  ...
  return (
    <div className='leftSide_container'>
      ...
      <div className='contactUs_container'>
        ...
        <ul>
          {contactUsValue.address ? <li>{contactUsValue.address}</li> : null}
          {contactUsValue.phone ? <li>{contactUsValue.phone}</li> : null}
          {contactUsValue.email ? <li>{contactUsValue.email}</li> : null}
          {contactUsValue.linkedin ? <li>{contactUsValue.linkedin}</li> : null}
          {contactUsValue.github ? <li>{contactUsValue.github}</li> : null}
        </ul>
        <div className='leftSIde_heading'>
